  ...
  return (
    <nav
      ...
      <ul
        ...
        <li className="ml-2 text-white text-xl p-2 md:p-3 hover:bg-blue-400 hover:text-white transition duration-300 ease-in-out rounded-full cursor-pointer">
          Home
        </li>
        <li className="ml-2 text-white text-xl p-2 md:p-3 hover:bg-blue-400 hover:text-white transition duration-300 ease-in-out rounded-full cursor-pointer">
          Products
      ...
      <div className="flex p-2 md:p-3">
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 md:py-1 md:px-3 lg:px-4 rounded">
          Login
        </button>
